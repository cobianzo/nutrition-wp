...
class About_Us extends Abstract_Module {
	...
	private function get_about_localization_data() {
		...
		return [
			...
			'strings'            => [
				'aboutUs'          => __( 'About us', 'fork' ),
				'heroHeader'       => __( 'Our Story', 'fork' ),
				'heroTextFirst'    => __( 'Themeisle was founded in 2012 by a group of passionate developers who wanted to create beautiful and functional WordPress themes and plugins. Since then, we have grown into a team of over 20 dedicated professionals who are committed to delivering the best possible products to our customers.', 'fork' ),
				'heroTextSecond'   => __( 'At Themeisle, we offer a wide range of WordPress themes and plugins that are designed to meet the needs of both beginners and advanced users. Our products are feature-rich, easy to use, and are designed to help you create beautiful and functional websites.', 'fork' ),
				'teamImageCaption' => __( 'Our team in WCEU2022 in Portugal', 'fork' ),
				'newsHeading'      => __( 'Stay connected for news & updates!', 'fork' ),
				'emailPlaceholder' => __( 'Your email address', 'fork' ),
				'signMeUp'         => __( 'Sign me up', 'fork' ),
				'installNow'       => __( 'Install Now', 'fork' ),
				'activate'         => __( 'Activate', 'fork' ),
				'learnMore'        => __( 'Learn More', 'fork' ),
				'installed'        => __( 'Installed', 'fork' ),
				'notInstalled'     => __( 'Not Installed', 'fork' ),
				'active'           => __( 'Active', 'fork' ),
			],
	...
	private function get_product_pages_data( $product_pages ) {
		...
		$pages = [
			'otter-page' => [
				...
				'plugin'  => $otter_plugin,
				'strings' => [
					'heading'      => __( 'Build innovative layouts with Otter Blocks and Gutenberg', 'fork' ),
					'text'         => __( 'Otter is a lightweight, dynamic collection of page building blocks and templates for the WordPress block editor.', 'fork' ),
					'buttons'      => [
						'install_otter_free' => __( "Install Otter - It's free!", 'fork' ),
						'install_now'        => __( 'Install Now', 'fork' ),
						'learn_more'         => __( 'Learn More', 'fork' ),
						'learn_more_link'    => tsdk_utmify( 'https://themeisle.com/plugins/otter-blocks/', 'otter-page', 'about-us' ),
					],
					'features'     => [
						'advancedTitle' => __( 'Advanced Features', 'fork' ),
						'advancedDesc'  => __( 'Add features such as Custom CSS, Animations & Visibility Conditions to all blocks.', 'fork' ),
						'fastTitle'     => __( 'Lightweight and Fast', 'fork' ),
						'fastDesc'      => __( 'Otter enhances WordPress site building experience without impacting site speed.', 'fork' ),
						'mobileTitle'   => __( 'Mobile-Friendly', 'fork' ),
						'mobileDesc'    => __( 'Each block can be tweaked to provide a consistent experience across all devices.', 'fork' ),
					],
					'details'      => [
						's1Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-builder.png',
						's1Title' => __( 'A Better Page Building Experience', 'fork' ),
						's1Text'  => __( 'Otter can be used to build everything from a personal blog to an e-commerce site without losing the personal touch. Otter’s ease of use transforms basic blocks into expressive layouts in seconds.', 'fork' ),
						's2Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-patterns.png',
						's2Title' => __( 'A New Collection of Patterns', 'fork' ),
						's2Text'  => __( 'A New Patterns Library, containing a range of different elements in a variety of styles to help you build great pages. All of your website’s most important areas are covered: headers, testimonials, pricing tables, sections and more.', 'fork' ),
						's3Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-library.png',
						's3Title' => __( 'Advanced Blocks', 'fork' ),
						's3Text'  => __( 'Enhance your website’s design with powerful blocks, like the Add to Cart, Business Hours, Review Comparison, and dozens of WooCommerce blocks.', 'fork' ),
					],
					'testimonials' => [
						'heading' => __( 'Trusted by more than 300K website owners', 'fork' ),
						'users'   => [
							[
	...
	private function get_other_products_data() {
		$products = [
			...
			'neve'                                => [
				'skip_api'    => true,
				'name'        => 'Neve',
				'description' => __( 'A fast, lightweight, customizable WordPress theme offering responsive design, speed, and flexibility for various website types.', 'fork' ),
			...
			'wp-landing-kit'                      => [
				...
				'name'        => 'WP Landing Kit',
				'description' => __( 'Turn WordPress into a landing page powerhouse with Landing Kit, map domains to pages or any other published resource.', 'fork' ),
			...
			'sparks-for-woocommerce'              => [
				...
				'name'        => 'Sparks',
				'description' => __( 'Extend your store functionality with 8 ultra-performant features like product comparisons, variation swatches, wishlist, and more.', 'fork' ),
				'icon'        => $this->get_sdk_uri() . 'assets/images/sparks.png',
				'condition'   => class_exists( 'WooCommerce', false ),
			],
			'templates-patterns-collection'       => [
				'name'        => 'Templates Cloud',
				'description' => __( 'Design, save, and revisit your templates anytime with your personal vault on Templates Cloud.', 'fork' ),
			],
		];
