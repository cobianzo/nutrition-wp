    ...
    private function getTableStructure($tableName, $chunk_index = 0, $chunk_mode = \false)
    {
        if (!$this->dumpSettings['no-create-info'] && !$chunk_mode || !$this->dumpSettings['no-create-info'] && $chunk_mode && 0 === $chunk_index) {
            ...
            foreach ($this->dbHandler->query($stmt) as $r) {
                ...
                $this->compressManager->write($this->typeAdapter->create_table($r, $ansi_quotes_enabled));
                break;
            }
        }
...
class TypeAdapterMysql extends TypeAdapterFactory
{
    ...
    public function backup_parameters()
    {
        $ret = "/*!40101 SET @OLD_CHARACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT */;" . \PHP_EOL . "/*!40101 SET @OLD_CHARACTER_SET_RESULTS=@@CHARACTER_SET_RESULTS */;" . \PHP_EOL . "/*!40101 SET @OLD_COLLATION_CONNECTION=@@COLLATION_CONNECTION */;" . \PHP_EOL;
        if (\false === $this->dumpSettings['skip-tz-utc']) {
